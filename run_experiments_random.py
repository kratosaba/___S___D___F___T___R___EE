...
# Overall question:is it better to do a change of some of the hyperparameters to understand on the IOT and time? Yes
# TODO  instead random create a grid search that takes into accont each interesting parameters to understand better how it influences the Iou.
# This other expermient will help me 
import metrics
import time
